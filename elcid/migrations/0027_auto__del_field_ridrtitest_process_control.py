...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RidRTITest.process_control'
        db.delete_column(u'elcid_ridrtitest', 'process_control')


    def backwards(self, orm):
        # Adding field 'RidRTITest.process_control'
        db.add_column(u'elcid_ridrtitest', 'process_control',
