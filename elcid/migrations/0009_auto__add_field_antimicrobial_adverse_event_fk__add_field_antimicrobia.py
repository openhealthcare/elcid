...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Antimicrobial.adverse_event_fk'
        db.add_column(u'elcid_antimicrobial', 'adverse_event_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Antimicrobial_adverse_event'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antimicrobial.adverse_event_ft'
        db.add_column(u'elcid_antimicrobial', 'adverse_event_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Antimicrobial.adverse_event_fk'
        db.delete_column(u'elcid_antimicrobial', 'adverse_event_fk_id')

        # Deleting field 'Antimicrobial.adverse_event_ft'
        db.delete_column(u'elcid_antimicrobial', 'adverse_event_ft')
