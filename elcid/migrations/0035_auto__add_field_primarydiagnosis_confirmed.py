...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrimaryDiagnosis.confirmed'
        db.add_column(u'elcid_primarydiagnosis', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrimaryDiagnosis.confirmed'
        db.delete_column(u'elcid_primarydiagnosis', 'confirmed')
