...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SecondaryDiagnosis.co_priamary'
        db.delete_column(u'elcid_secondarydiagnosis', 'co_priamary')

        # Adding field 'SecondaryDiagnosis.co_primary'
        db.add_column(u'elcid_secondarydiagnosis', 'co_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SecondaryDiagnosis.co_priamary'
        db.add_column(u'elcid_secondarydiagnosis', 'co_priamary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SecondaryDiagnosis.co_primary'
        db.delete_column(u'elcid_secondarydiagnosis', 'co_primary')
