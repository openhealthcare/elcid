...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PresentingComplaint.duration_fk'
        db.delete_column(u'elcid_presentingcomplaint', 'duration_fk_id')

        # Deleting field 'PresentingComplaint.duration_ft'
        db.delete_column(u'elcid_presentingcomplaint', 'duration_ft')

        # Adding field 'PresentingComplaint.duration'
        db.add_column(u'elcid_presentingcomplaint', 'duration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PresentingComplaint.duration_fk'
        db.add_column(u'elcid_presentingcomplaint', 'duration_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Duration'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PresentingComplaint.duration_ft'
        db.add_column(u'elcid_presentingcomplaint', 'duration_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PresentingComplaint.duration'
        db.delete_column(u'elcid_presentingcomplaint', 'duration')
