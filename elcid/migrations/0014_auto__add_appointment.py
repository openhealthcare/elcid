...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'elcid_appointment', (
            ...
            ('appointment_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('appointment_with', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'elcid', ['Appointment'])


    def backwards(self, orm):
        # Deleting model 'Appointment'
        db.delete_table(u'elcid_appointment')
