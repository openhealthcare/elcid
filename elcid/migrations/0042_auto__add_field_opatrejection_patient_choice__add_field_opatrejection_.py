...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OPATRejection.patient_choice'
        db.add_column(u'elcid_opatrejection', 'patient_choice',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OPATRejection.oral_available'
        db.add_column(u'elcid_opatrejection', 'oral_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OPATRejection.not_needed'
        db.add_column(u'elcid_opatrejection', 'not_needed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OPATRejection.patient_suitability'
        db.add_column(u'elcid_opatrejection', 'patient_suitability',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OPATRejection.not_fit_for_discharge'
        db.add_column(u'elcid_opatrejection', 'not_fit_for_discharge',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OPATRejection.no_social_support'
        db.add_column(u'elcid_opatrejection', 'no_social_support',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OPATRejection.patient_choice'
        db.delete_column(u'elcid_opatrejection', 'patient_choice')

        # Deleting field 'OPATRejection.oral_available'
        db.delete_column(u'elcid_opatrejection', 'oral_available')

        # Deleting field 'OPATRejection.not_needed'
        db.delete_column(u'elcid_opatrejection', 'not_needed')

        # Deleting field 'OPATRejection.patient_suitability'
        db.delete_column(u'elcid_opatrejection', 'patient_suitability')

        # Deleting field 'OPATRejection.not_fit_for_discharge'
        db.delete_column(u'elcid_opatrejection', 'not_fit_for_discharge')

        # Deleting field 'OPATRejection.no_social_support'
        db.delete_column(u'elcid_opatrejection', 'no_social_support')
