...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabTest.antimicrobials_resistant_fk'
        db.add_column(u'elcid_labtest', 'antimicrobials_resistant_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resistant', null=True, to=orm['elcid.Antimicrobial_susceptability']),
                      keep_default=False)

        # Adding field 'LabTest.antimicrobials_resistant_ft'
        db.add_column(u'elcid_labtest', 'antimicrobials_resistant_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LabTest.antimicrobials_susceptible_fk'
        db.add_column(u'elcid_labtest', 'antimicrobials_susceptible_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='susceptible', null=True, to=orm['elcid.Antimicrobial_susceptability']),
                      keep_default=False)

        # Adding field 'LabTest.antimicrobials_susceptible_ft'
        db.add_column(u'elcid_labtest', 'antimicrobials_susceptible_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LabTest.antimicrobials_intermediate_fk'
        db.add_column(u'elcid_labtest', 'antimicrobials_intermediate_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='intermediate', null=True, to=orm['elcid.Antimicrobial_susceptability']),
                      keep_default=False)

        # Adding field 'LabTest.antimicrobials_intermediate_ft'
        db.add_column(u'elcid_labtest', 'antimicrobials_intermediate_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LabTest.antimicrobials_resistant_fk'
        db.delete_column(u'elcid_labtest', 'antimicrobials_resistant_fk_id')

        # Deleting field 'LabTest.antimicrobials_resistant_ft'
        db.delete_column(u'elcid_labtest', 'antimicrobials_resistant_ft')

        # Deleting field 'LabTest.antimicrobials_susceptible_fk'
        db.delete_column(u'elcid_labtest', 'antimicrobials_susceptible_fk_id')

        # Deleting field 'LabTest.antimicrobials_susceptible_ft'
        db.delete_column(u'elcid_labtest', 'antimicrobials_susceptible_ft')

        # Deleting field 'LabTest.antimicrobials_intermediate_fk'
        db.delete_column(u'elcid_labtest', 'antimicrobials_intermediate_fk_id')

        # Deleting field 'LabTest.antimicrobials_intermediate_ft'
        db.delete_column(u'elcid_labtest', 'antimicrobials_intermediate_ft')
    ...
    models = {
        ...
        u'elcid.opatoutcome': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'patient_feedback': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'readmission_cause': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'readmitted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'treatment_outcome': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'elcid.opatrejection': {
            ...
            'non_complex_infection': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'elcid.travel': {
            ...
            'malaria_prophylaxis': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
