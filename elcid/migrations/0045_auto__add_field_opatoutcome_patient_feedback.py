...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OPATOutcome.patient_feedback'
        db.add_column(u'elcid_opatoutcome', 'patient_feedback',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OPATOutcome.patient_feedback'
        db.delete_column(u'elcid_opatoutcome', 'patient_feedback')
