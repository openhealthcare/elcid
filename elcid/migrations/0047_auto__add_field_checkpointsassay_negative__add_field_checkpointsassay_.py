...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckpointsAssay.negative'
        db.add_column(u'elcid_checkpointsassay', 'negative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CheckpointsAssay.comments'
        db.add_column(u'elcid_checkpointsassay', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckpointsAssay.negative'
        db.delete_column(u'elcid_checkpointsassay', 'negative')

        # Deleting field 'CheckpointsAssay.comments'
        db.delete_column(u'elcid_checkpointsassay', 'comments')
