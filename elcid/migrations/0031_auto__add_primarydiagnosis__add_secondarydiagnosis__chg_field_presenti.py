...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrimaryDiagnosis'
        db.create_table(u'elcid_primarydiagnosis', (
        ...
        db.send_create_signal(u'elcid', ['PrimaryDiagnosis'])

        # Adding model 'SecondaryDiagnosis'
        db.create_table(u'elcid_secondarydiagnosis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True)),
            ('co_priamary', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('condition_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Condition'], null=True, blank=True)),
            ('condition_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'elcid', ['SecondaryDiagnosis'])


        # Changing field 'PresentingComplaint.details'
        db.alter_column(u'elcid_presentingcomplaint', 'details', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PresentingComplaint.duration'
        db.alter_column(u'elcid_presentingcomplaint', 'duration', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting model 'PrimaryDiagnosis'
        db.delete_table(u'elcid_primarydiagnosis')

        # Deleting model 'SecondaryDiagnosis'
        db.delete_table(u'elcid_secondarydiagnosis')


        # Changing field 'PresentingComplaint.details'
        db.alter_column(u'elcid_presentingcomplaint', 'details', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'PresentingComplaint.duration'
        db.alter_column(u'elcid_presentingcomplaint', 'duration', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
