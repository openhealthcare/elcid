...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabSpecimin.biobanking_box'
        db.add_column(u'elcid_labspecimin', 'biobanking_box',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabSpecimin.biobanking_box'
        db.delete_column(u'elcid_labspecimin', 'biobanking_box')
