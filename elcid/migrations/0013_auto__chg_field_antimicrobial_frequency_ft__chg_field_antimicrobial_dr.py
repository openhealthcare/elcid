...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Antimicrobial.frequency_ft'
        db.alter_column(u'elcid_antimicrobial', 'frequency_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Antimicrobial.drug_ft'
        db.alter_column(u'elcid_antimicrobial', 'drug_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Antimicrobial.route_ft'
        db.alter_column(u'elcid_antimicrobial', 'route_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Antimicrobial.adverse_event_ft'
        db.alter_column(u'elcid_antimicrobial', 'adverse_event_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PastMedicalHistory.condition_ft'
        db.alter_column(u'elcid_pastmedicalhistory', 'condition_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Line.line_type_ft'
        db.alter_column(u'elcid_line', 'line_type_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Line.removal_reason_ft'
        db.alter_column(u'elcid_line', 'removal_reason_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Line.complications_ft'
        db.alter_column(u'elcid_line', 'complications_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Line.site_ft'
        db.alter_column(u'elcid_line', 'site_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Location.opat_referral_team_address'
        db.add_column(u'elcid_location', 'opat_referral_team_address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Diagnosis.condition_ft'
        db.alter_column(u'elcid_diagnosis', 'condition_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Allergies.drug_ft'
        db.alter_column(u'elcid_allergies', 'drug_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Travel.reason_for_travel_ft'
        db.alter_column(u'elcid_travel', 'reason_for_travel_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Travel.destination_ft'
        db.alter_column(u'elcid_travel', 'destination_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Demographics.country_of_birth_ft'
        db.alter_column(u'elcid_demographics', 'country_of_birth_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobiologyInput.reason_for_interaction_ft'
        db.alter_column(u'elcid_microbiologyinput', 'reason_for_interaction_ft', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Antimicrobial.frequency_ft'
        db.alter_column(u'elcid_antimicrobial', 'frequency_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Antimicrobial.drug_ft'
        db.alter_column(u'elcid_antimicrobial', 'drug_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Antimicrobial.route_ft'
        db.alter_column(u'elcid_antimicrobial', 'route_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Antimicrobial.adverse_event_ft'
        db.alter_column(u'elcid_antimicrobial', 'adverse_event_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'PastMedicalHistory.condition_ft'
        db.alter_column(u'elcid_pastmedicalhistory', 'condition_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Line.line_type_ft'
        db.alter_column(u'elcid_line', 'line_type_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Line.removal_reason_ft'
        db.alter_column(u'elcid_line', 'removal_reason_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Line.complications_ft'
        db.alter_column(u'elcid_line', 'complications_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Line.site_ft'
        db.alter_column(u'elcid_line', 'site_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
        # Deleting field 'Location.opat_referral_team_address'
        db.delete_column(u'elcid_location', 'opat_referral_team_address')


        # Changing field 'Diagnosis.condition_ft'
        db.alter_column(u'elcid_diagnosis', 'condition_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Allergies.drug_ft'
        db.alter_column(u'elcid_allergies', 'drug_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Travel.reason_for_travel_ft'
        db.alter_column(u'elcid_travel', 'reason_for_travel_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Travel.destination_ft'
        db.alter_column(u'elcid_travel', 'destination_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Demographics.country_of_birth_ft'
        db.alter_column(u'elcid_demographics', 'country_of_birth_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobiologyInput.reason_for_interaction_ft'
        db.alter_column(u'elcid_microbiologyinput', 'reason_for_interaction_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
