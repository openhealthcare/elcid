...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OPATReview.time'
        db.delete_column(u'elcid_opatreview', 'time')

        # Deleting field 'OPATReview.date'
        db.delete_column(u'elcid_opatreview', 'date')

        # Adding field 'OPATReview.datetime'
        db.add_column(u'elcid_opatreview', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OPATReview.time'
        db.add_column(u'elcid_opatreview', 'time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OPATReview.date'
        db.add_column(u'elcid_opatreview', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OPATReview.datetime'
        db.delete_column(u'elcid_opatreview', 'datetime')
