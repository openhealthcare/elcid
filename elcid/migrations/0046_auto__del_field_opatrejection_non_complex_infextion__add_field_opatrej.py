...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OPATRejection.non_complex_infextion'
        db.delete_column(u'elcid_opatrejection', 'non_complex_infextion')

        # Adding field 'OPATRejection.non_complex_infection'
        db.add_column(u'elcid_opatrejection', 'non_complex_infection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OPATRejection.non_complex_infextion'
        db.add_column(u'elcid_opatrejection', 'non_complex_infextion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'OPATRejection.non_complex_infection'
        db.delete_column(u'elcid_opatrejection', 'non_complex_infection')
