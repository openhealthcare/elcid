...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Travel.rural_exposure'
        db.add_column(u'elcid_travel', 'rural_exposure',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Travel.rural_exposure'
        db.delete_column(u'elcid_travel', 'rural_exposure')
