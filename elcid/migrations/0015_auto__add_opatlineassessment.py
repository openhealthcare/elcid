...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OPATLineAssessment'
        db.create_table(u'elcid_opatlineassessment', (
            ...
            ('assessment_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('vip_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('dressing_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('dressing_change_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('dressing_change_reason', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('bionector_change_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'elcid', ['OPATLineAssessment'])


    def backwards(self, orm):
        # Deleting model 'OPATLineAssessment'
        db.delete_table(u'elcid_opatlineassessment')
