...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OPATReview.rv_type'
        db.delete_column(u'elcid_opatreview', 'rv_type')

        # Adding field 'OPATReview.rv_type_fk'
        db.add_column(u'elcid_opatreview', 'rv_type_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Opat_rvt'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OPATReview.rv_type_ft'
        db.add_column(u'elcid_opatreview', 'rv_type_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OPATReview.rv_type'
        db.add_column(u'elcid_opatreview', 'rv_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OPATReview.rv_type_fk'
        db.delete_column(u'elcid_opatreview', 'rv_type_fk_id')

        # Deleting field 'OPATReview.rv_type_ft'
        db.delete_column(u'elcid_opatreview', 'rv_type_ft')
