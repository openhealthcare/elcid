...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Line.insertion_date'
        db.delete_column(u'elcid_line', 'insertion_date')

        # Deleting field 'Line.removal_date'
        db.delete_column(u'elcid_line', 'removal_date')
        ...
        # Adding field 'Line.insertion_datetime'
        db.add_column(u'elcid_line', 'insertion_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Line.removal_datetime'
        db.add_column(u'elcid_line', 'removal_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Line.insertion_date'
        db.add_column(u'elcid_line', 'insertion_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Line.removal_date'
        db.add_column(u'elcid_line', 'removal_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Line.insertion_datetime'
        db.delete_column(u'elcid_line', 'insertion_datetime')

        # Deleting field 'Line.removal_datetime'
        db.delete_column(u'elcid_line', 'removal_datetime')
