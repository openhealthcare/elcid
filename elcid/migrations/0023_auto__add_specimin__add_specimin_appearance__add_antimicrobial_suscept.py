...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db(mading model 'Specimin'
        db.create_table(u'elcid_specimin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Specimin'])

        # Adding model 'Specimin_appearance'
        db.create_table(u'elcid_specimin_appearance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Specimin_appearance'])

        # Adding model 'Antimicrobial_susceptability'
        db.create_table(u'elcid_antimicrobial_susceptability', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Antimicrobial_susceptability'])

        # Adding model 'LabTest'
        db.create_table(u'elcid_labtest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('antimicrobial_suceptability_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Antimicrobial_susceptability'], null=True, blank=True)),
            ('antimicrobial_suceptability_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ('organism_details_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Organism_details'], null=True, blank=True)),
            ('organism_details_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'elcid', ['LabTest'])

        # Adding model 'Organism_details'
        db.create_table(u'elcid_organism_details', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Organism_details'])

        # Adding model 'LabSpecimin'
        db.create_table(u'elcid_labspecimin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True)),
            ...
            ('specimin_type_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Specimin'], null=True, blank=True)),
            ('specimin_type_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ('appearance_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Specimin_appearance'], null=True, blank=True)),
            ('appearance_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'elcid', ['LabSpecimin'])


    def backwards(self, orm):
        # Deleting model 'Specimin'
        db.delete_table(u'elcid_specimin')
        ...
        db.delete_table(u'elcid_labtest')

        # Deleting model 'Organism_details'
        db.delete_table(u'elcid_organism_details')

        # Deleting model 'LabSpecimin'
        db.delete_table(u'elcid_labspecimin')
