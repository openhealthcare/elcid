...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'elcid_location', 'discharge_date')

        # Deleting field 'Location.date_of_admission'
        db.delete_column(u'elcid_location', 'date_of_admission')


    def backwards(self, orm):
        # Adding field 'Location.discharge_date'
        db.add_column(u'elcid_location', 'discharge_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.date_of_admission'
        db.add_column(u'elcid_location', 'date_of_admission',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
