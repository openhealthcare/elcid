...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MicrobiologyTest.reason_not_done_fk'
        db.add_column(u'elcid_microbiologytest', 'reason_not_done_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Microbiology_reason_not_done'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MicrobiologyTest.reason_not_done_ft'
        db.add_column(u'elcid_microbiologytest', 'reason_not_done_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MicrobiologyTest.reason_not_done_fk'
        db.delete_column(u'elcid_microbiologytest', 'reason_not_done_fk_id')

        # Deleting field 'MicrobiologyTest.reason_not_done_ft'
        db.delete_column(u'elcid_microbiologytest', 'reason_not_done_ft')
    ...
    models = {
        ...
        u'elcid.microbiologytest': {
            ...
            'parainfluenza': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'parasitaemia': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'reason_not_done_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Microbiology_reason_not_done']", 'null': 'True', 'blank': 'True'}),
            'reason_not_done_ft': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'resistant_antibiotics': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'rotavirus': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'rpr': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
        ...
        u'elcid.travel': {
            ...
            'rural_exposure': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
