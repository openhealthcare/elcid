...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Hiv_no'
        db.create_table(u'elcid_hiv_no', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Hiv_no'])

        # Deleting field 'MicrobiologyTest.hiv_declined'
        db.delete_column(u'elcid_microbiologytest', 'hiv_declined')

        # Adding field 'MicrobiologyTest.hiv_declined_fk'
        db.add_column(u'elcid_microbiologytest', 'hiv_declined_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Hiv_no'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MicrobiologyTest.hiv_declined_ft'
        db.add_column(u'elcid_microbiologytest', 'hiv_declined_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Hiv_no'
        db.delete_table(u'elcid_hiv_no')

        # Adding field 'MicrobiologyTest.hiv_declined'
        db.add_column(u'elcid_microbiologytest', 'hiv_declined',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'MicrobiologyTest.hiv_declined_fk'
        db.delete_column(u'elcid_microbiologytest', 'hiv_declined_fk_id')

        # Deleting field 'MicrobiologyTest.hiv_declined_ft'
        db.delete_column(u'elcid_microbiologytest', 'hiv_declined_ft')
