...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'elcid_reportedinfection', (
            ...
            ('infection_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.ReportedInfections'], null=True, blank=True)),
    ...
    models = {
        ...
        u'elcid.reportedinfection': {
            'Meta': {'object_name': 'ReportedInfection'},
            'consistency_token': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'date_reported': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'episode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Episode']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'infection_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Reported_infections']", 'null': 'True', 'blank': 'True'}),
