...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Line.external_length'
        db.add_column(u'elcid_line', 'external_length',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Line.external_length'
        db.delete_column(u'elcid_line', 'external_length')
