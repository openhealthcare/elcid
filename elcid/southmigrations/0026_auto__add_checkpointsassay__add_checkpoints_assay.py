...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CheckpointsAssay'
        db.create_table(u'elcid_checkpointsassay', (
            ...
            ('checkpoint', self.gf('django.db.models.fields.CharField')(max_length='200', null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'elcid', ['CheckpointsAssay'])

        # Adding model 'Checkpoints_assay'
        db.create_table(u'elcid_checkpoints_assay', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Checkpoints_assay'])


    def backwards(self, orm):
        # Deleting model 'CheckpointsAssay'
        db.delete_table(u'elcid_checkpointsassay')

        # Deleting model 'Checkpoints_assay'
        db.delete_table(u'elcid_checkpoints_assay')
