...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Line.complications'
        db.delete_column(u'elcid_line', 'complications')

        # Adding field 'Line.complications_fk'
        db.add_column(u'elcid_line', 'complications_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Line_complication'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Line.complications_ft'
        db.add_column(u'elcid_line', 'complications_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Line.complications'
        db.add_column(u'elcid_line', 'complications',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Line.complications_fk'
        db.delete_column(u'elcid_line', 'complications_fk_id')

        # Deleting field 'Line.complications_ft'
        db.delete_column(u'elcid_line', 'complications_ft')
