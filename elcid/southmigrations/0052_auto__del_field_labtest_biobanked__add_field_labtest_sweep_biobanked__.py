...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LabTest.biobanked'
        db.delete_column(u'elcid_labtest', 'biobanked')

        # Adding field 'LabTest.sweep_biobanked'
        db.add_column(u'elcid_labtest', 'sweep_biobanked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LabTest.organism_biobanked'
        db.add_column(u'elcid_labtest', 'organism_biobanked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LabTest.biobanked'
        db.add_column(u'elcid_labtest', 'biobanked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'LabTest.sweep_biobanked'
        db.delete_column(u'elcid_labtest', 'sweep_biobanked')

        # Deleting field 'LabTest.organism_biobanked'
        db.delete_column(u'elcid_labtest', 'organism_biobanked')
