...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OPATOutcome'
        db.create_table(u'elcid_opatoutcome', (
            ...
            ('treatment_outcome', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('deceased', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('death_category', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('cause_of_death', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('readmitted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('readmission_cause', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'elcid', ['OPATOutcome'])


    def backwards(self, orm):
        # Deleting model 'OPATOutcome'
        db.delete_table(u'elcid_opatoutcome')
