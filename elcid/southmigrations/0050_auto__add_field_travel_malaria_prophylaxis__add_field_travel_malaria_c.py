...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Travel.malaria_prophylaxis'
        db.add_column(u'elcid_travel', 'malaria_prophylaxis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Travel.malaria_compliance'
        db.add_column(u'elcid_travel', 'malaria_compliance',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Travel.malaria_drug_fk'
        db.add_column(u'elcid_travel', 'malaria_drug_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Antimicrobial'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Travel.malaria_drug_ft'
        db.add_column(u'elcid_travel', 'malaria_drug_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Travel.malaria_prophylaxis'
        db.delete_column(u'elcid_travel', 'malaria_prophylaxis')

        # Deleting field 'Travel.malaria_compliance'
        db.delete_column(u'elcid_travel', 'malaria_compliance')

        # Deleting field 'Travel.malaria_drug_fk'
        db.delete_column(u'elcid_travel', 'malaria_drug_fk_id')

        # Deleting field 'Travel.malaria_drug_ft'
        db.delete_column(u'elcid_travel', 'malaria_drug_ft')
