...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OPATMeta.reason_for_stopping'
        db.alter_column(u'elcid_opatmeta', 'reason_for_stopping', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'OPATMeta.reason_for_stopping'
        db.alter_column(u'elcid_opatmeta', 'reason_for_stopping', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
