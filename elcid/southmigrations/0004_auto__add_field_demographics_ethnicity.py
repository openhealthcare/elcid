...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demographics.ethnicity'
        db.add_column(u'elcid_demographics', 'ethnicity',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demographics.ethnicity'
        db.delete_column(u'elcid_demographics', 'ethnicity')
