...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RidRTITest'
        db.create_table(u'elcid_ridrtitest', (
            ...
            ('test', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('process_control', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('pseudomonas_aeruginosa', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('absm', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('klebsiella_spp', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('essa', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('staphylococcus_mrsa', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ctx_m', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('shv_esbl', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tem_esbl', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('vim', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('imp', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ndm', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('kpc', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('oxa_48', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('meca', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('mycoplasma_pneumoniae', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('chlamydophila_pneumoniae', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('legionella_pneumophila', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('mtc', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('haemophilus_influenzae', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('streptococcus_pneumoniae', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rsva', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rsvb', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('influenza_a', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('influenza_b_coronavirus_oc43', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('coronavirus_nl63_229e', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('nocardia_spp', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rhodococcus_equi', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ascn', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pneumocystis_jiroveci', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('coronavirus_oc43', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('coronavirus_nl63', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'elcid', ['RidRTITest'])


    def backwards(self, orm):
        # Deleting model 'RidRTITest'
        db.delete_table(u'elcid_ridrtitest')
