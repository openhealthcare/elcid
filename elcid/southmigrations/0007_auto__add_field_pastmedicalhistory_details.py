...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PastMedicalHistory.details'
        db.add_column(u'elcid_pastmedicalhistory', 'details',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PastMedicalHistory.details'
        db.delete_column(u'elcid_pastmedicalhistory', 'details')
