...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MicrobiologyTest.result'
        db.alter_column(u'elcid_microbiologytest', 'result', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'MicrobiologyTest.result'
        db.alter_column(u'elcid_microbiologytest', 'result', self.gf('django.db.models.fields.CharField')(max_length=20))
