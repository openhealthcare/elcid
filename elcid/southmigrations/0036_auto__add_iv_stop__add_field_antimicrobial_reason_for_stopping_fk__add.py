...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Iv_stop'
        db.create_table(u'elcid_iv_stop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Iv_stop'])

        # Adding field 'Antimicrobial.reason_for_stopping_fk'
        db.add_column(u'elcid_antimicrobial', 'reason_for_stopping_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Iv_stop'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antimicrobial.reason_for_stopping_ft'
        db.add_column(u'elcid_antimicrobial', 'reason_for_stopping_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Iv_stop'
        db.delete_table(u'elcid_iv_stop')

        # Deleting field 'Antimicrobial.reason_for_stopping_fk'
        db.delete_column(u'elcid_antimicrobial', 'reason_for_stopping_fk_id')

        # Deleting field 'Antimicrobial.reason_for_stopping_ft'
        db.delete_column(u'elcid_antimicrobial', 'reason_for_stopping_ft')
