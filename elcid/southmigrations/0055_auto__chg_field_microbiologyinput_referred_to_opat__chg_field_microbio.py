...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MicrobiologyInput.referred_to_opat'
        db.alter_column(u'elcid_microbiologyinput', 'referred_to_opat', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'MicrobiologyInput.change_in_antibiotic_prescription'
        db.alter_column(u'elcid_microbiologyinput', 'change_in_antibiotic_prescription', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'MicrobiologyInput.clinical_advice_given'
        db.alter_column(u'elcid_microbiologyinput', 'clinical_advice_given', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'MicrobiologyInput.infection_control_advice_given'
        db.alter_column(u'elcid_microbiologyinput', 'infection_control_advice_given', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'MicrobiologyInput.referred_to_opat'
        db.alter_column(u'elcid_microbiologyinput', 'referred_to_opat', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'MicrobiologyInput.change_in_antibiotic_prescription'
        db.alter_column(u'elcid_microbiologyinput', 'change_in_antibiotic_prescription', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'MicrobiologyInput.clinical_advice_given'
        db.alter_column(u'elcid_microbiologyinput', 'clinical_advice_given', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'MicrobiologyInput.infection_control_advice_given'
        db.alter_column(u'elcid_microbiologyinput', 'infection_control_advice_given', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'elcid.labtest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organism_biobanked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'sweep_biobanked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
