...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'elcid_microbiologytest', 'hiv_declined',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'elcid.microbiologytest': {
            ...
            'hiv_declined': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
