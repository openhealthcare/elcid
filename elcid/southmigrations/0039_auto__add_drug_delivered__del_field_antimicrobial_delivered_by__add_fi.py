...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Drug_delivered'
        db.create_table(u'elcid_drug_delivered', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'elcid', ['Drug_delivered'])

        # Deleting field 'Antimicrobial.delivered_by'
        db.delete_column(u'elcid_antimicrobial', 'delivered_by')

        # Adding field 'Antimicrobial.delivered_by_fk'
        db.add_column(u'elcid_antimicrobial', 'delivered_by_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elcid.Drug_delivered'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antimicrobial.delivered_by_ft'
        db.add_column(u'elcid_antimicrobial', 'delivered_by_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Drug_delivered'
        db.delete_table(u'elcid_drug_delivered')
        ...
        # Deleting field 'Antimicrobial.delivered_by_fk'
        db.delete_column(u'elcid_antimicrobial', 'delivered_by_fk_id')

        # Deleting field 'Antimicrobial.delivered_by_ft'
        db.delete_column(u'elcid_antimicrobial', 'delivered_by_ft')
