...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RidRTITest.episode'
        db.alter_column(u'elcid_ridrtitest', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'OPATMeta.episode'
        db.alter_column(u'elcid_opatmeta', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'OPATLineAssessment.episode'
        db.alter_column(u'elcid_opatlineassessment', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'PresentingComplaint.episode'
        db.alter_column(u'elcid_presentingcomplaint', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'PrimaryDiagnosis.episode'
        db.alter_column(u'elcid_primarydiagnosis', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'MicrobiologyInput.episode'
        db.alter_column(u'elcid_microbiologyinput', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Antimicrobial.episode'
        db.alter_column(u'elcid_antimicrobial', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'GeneralNote.episode'
        db.alter_column(u'elcid_generalnote', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'LabTest.episode'
        db.alter_column(u'elcid_labtest', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'CheckpointsAssay.episode'
        db.alter_column(u'elcid_checkpointsassay', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Location.episode'
        db.alter_column(u'elcid_location', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Diagnosis.episode'
        db.alter_column(u'elcid_diagnosis', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Appointment.episode'
        db.alter_column(u'elcid_appointment', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'SecondaryDiagnosis.episode'
        db.alter_column(u'elcid_secondarydiagnosis', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'OPATReview.episode'
        db.alter_column(u'elcid_opatreview', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Line.episode'
        db.alter_column(u'elcid_line', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Todo.episode'
        db.alter_column(u'elcid_todo', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'MicrobiologyTest.episode'
        db.alter_column(u'elcid_microbiologytest', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'PastMedicalHistory.episode'
        db.alter_column(u'elcid_pastmedicalhistory', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'LabSpecimin.episode'
        db.alter_column(u'elcid_labspecimin', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'OPATRejection.episode'
        db.alter_column(u'elcid_opatrejection', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'Travel.episode'
        db.alter_column(u'elcid_travel', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

        # Changing field 'OPATOutstandingIssues.episode'
        db.alter_column(u'elcid_opatoutstandingissues', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

    def backwards(self, orm):

        # Changing field 'RidRTITest.episode'
        db.alter_column(u'elcid_ridrtitest', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'OPATMeta.episode'
        db.alter_column(u'elcid_opatmeta', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'OPATLineAssessment.episode'
        db.alter_column(u'elcid_opatlineassessment', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'PresentingComplaint.episode'
        db.alter_column(u'elcid_presentingcomplaint', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'PrimaryDiagnosis.episode'
        db.alter_column(u'elcid_primarydiagnosis', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'MicrobiologyInput.episode'
        db.alter_column(u'elcid_microbiologyinput', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Antimicrobial.episode'
        db.alter_column(u'elcid_antimicrobial', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'GeneralNote.episode'
        db.alter_column(u'elcid_generalnote', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'LabTest.episode'
        db.alter_column(u'elcid_labtest', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'CheckpointsAssay.episode'
        db.alter_column(u'elcid_checkpointsassay', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Location.episode'
        db.alter_column(u'elcid_location', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Diagnosis.episode'
        db.alter_column(u'elcid_diagnosis', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Appointment.episode'
        db.alter_column(u'elcid_appointment', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'SecondaryDiagnosis.episode'
        db.alter_column(u'elcid_secondarydiagnosis', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'OPATReview.episode'
        db.alter_column(u'elcid_opatreview', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Line.episode'
        db.alter_column(u'elcid_line', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Todo.episode'
        db.alter_column(u'elcid_todo', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'MicrobiologyTest.episode'
        db.alter_column(u'elcid_microbiologytest', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'PastMedicalHistory.episode'
        db.alter_column(u'elcid_pastmedicalhistory', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'LabSpecimin.episode'
        db.alter_column(u'elcid_labspecimin', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'OPATRejection.episode'
        db.alter_column(u'elcid_opatrejection', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'Travel.episode'
        db.alter_column(u'elcid_travel', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))

        # Changing field 'OPATOutstandingIssues.episode'
        db.alter_column(u'elcid_opatoutstandingissues', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))
