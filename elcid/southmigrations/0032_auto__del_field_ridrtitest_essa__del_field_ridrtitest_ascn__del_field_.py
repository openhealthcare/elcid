...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RidRTITest.essa'
        db.delete_column(u'elcid_ridrtitest', 'essa')

        # Deleting field 'RidRTITest.ascn'
        db.delete_column(u'elcid_ridrtitest', 'ascn')

        # Deleting field 'RidRTITest.coronavirus_nl63_229e'
        db.delete_column(u'elcid_ridrtitest', 'coronavirus_nl63_229e')

        # Deleting field 'RidRTITest.coronavirus_nl63'
        db.delete_column(u'elcid_ridrtitest', 'coronavirus_nl63')

        # Deleting field 'RidRTITest.coronavirus_oc43'
        db.delete_column(u'elcid_ridrtitest', 'coronavirus_oc43')

        # Deleting field 'RidRTITest.absm'
        db.delete_column(u'elcid_ridrtitest', 'absm')

        # Deleting field 'RidRTITest.influenza_b_coronavirus_oc43'
        db.delete_column(u'elcid_ridrtitest', 'influenza_b_coronavirus_oc43')

        # Adding field 'RidRTITest.acinetobacter_baumannii'
        db.add_column(u'elcid_ridrtitest', 'acinetobacter_baumannii',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.senotophomonas_maltophilia'
        db.add_column(u'elcid_ridrtitest', 'senotophomonas_maltophilia',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.enterobacter_spp'
        db.add_column(u'elcid_ridrtitest', 'enterobacter_spp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.staphylococcus_aureus'
        db.add_column(u'elcid_ridrtitest', 'staphylococcus_aureus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.influenza_b'
        db.add_column(u'elcid_ridrtitest', 'influenza_b',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.cap_coronavirus_oc43'
        db.add_column(u'elcid_ridrtitest', 'cap_coronavirus_oc43',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.cap_coronavirus_hku1'
        db.add_column(u'elcid_ridrtitest', 'cap_coronavirus_hku1',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.cap_coronavirus_nl63'
        db.add_column(u'elcid_ridrtitest', 'cap_coronavirus_nl63',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.cap_coronavirus_229e'
        db.add_column(u'elcid_ridrtitest', 'cap_coronavirus_229e',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.aspergillus_spp'
        db.add_column(u'elcid_ridrtitest', 'aspergillus_spp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.cryptococcus_neoformans'
        db.add_column(u'elcid_ridrtitest', 'cryptococcus_neoformans',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.orti_coronavirus_oc43'
        db.add_column(u'elcid_ridrtitest', 'orti_coronavirus_oc43',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.orti_coronavirus_hku1'
        db.add_column(u'elcid_ridrtitest', 'orti_coronavirus_hku1',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.orti_coronavirus_nl63'
        db.add_column(u'elcid_ridrtitest', 'orti_coronavirus_nl63',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.orti_coronavirus_229e'
        db.add_column(u'elcid_ridrtitest', 'orti_coronavirus_229e',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RidRTITest.essa'
        db.add_column(u'elcid_ridrtitest', 'essa',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.ascn'
        db.add_column(u'elcid_ridrtitest', 'ascn',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.coronavirus_nl63_229e'
        db.add_column(u'elcid_ridrtitest', 'coronavirus_nl63_229e',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.coronavirus_nl63'
        db.add_column(u'elcid_ridrtitest', 'coronavirus_nl63',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.coronavirus_oc43'
        db.add_column(u'elcid_ridrtitest', 'coronavirus_oc43',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.absm'
        db.add_column(u'elcid_ridrtitest', 'absm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RidRTITest.influenza_b_coronavirus_oc43'
        db.add_column(u'elcid_ridrtitest', 'influenza_b_coronavirus_oc43',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'RidRTITest.acinetobacter_baumannii'
        db.delete_column(u'elcid_ridrtitest', 'acinetobacter_baumannii')

        # Deleting field 'RidRTITest.senotophomonas_maltophilia'
        db.delete_column(u'elcid_ridrtitest', 'senotophomonas_maltophilia')

        # Deleting field 'RidRTITest.enterobacter_spp'
        db.delete_column(u'elcid_ridrtitest', 'enterobacter_spp')

        # Deleting field 'RidRTITest.staphylococcus_aureus'
        db.delete_column(u'elcid_ridrtitest', 'staphylococcus_aureus')

        # Deleting field 'RidRTITest.influenza_b'
        db.delete_column(u'elcid_ridrtitest', 'influenza_b')

        # Deleting field 'RidRTITest.cap_coronavirus_oc43'
        db.delete_column(u'elcid_ridrtitest', 'cap_coronavirus_oc43')

        # Deleting field 'RidRTITest.cap_coronavirus_hku1'
        db.delete_column(u'elcid_ridrtitest', 'cap_coronavirus_hku1')

        # Deleting field 'RidRTITest.cap_coronavirus_nl63'
        db.delete_column(u'elcid_ridrtitest', 'cap_coronavirus_nl63')

        # Deleting field 'RidRTITest.cap_coronavirus_229e'
        db.delete_column(u'elcid_ridrtitest', 'cap_coronavirus_229e')

        # Deleting field 'RidRTITest.aspergillus_spp'
        db.delete_column(u'elcid_ridrtitest', 'aspergillus_spp')

        # Deleting field 'RidRTITest.cryptococcus_neoformans'
        db.delete_column(u'elcid_ridrtitest', 'cryptococcus_neoformans')

        # Deleting field 'RidRTITest.orti_coronavirus_oc43'
        db.delete_column(u'elcid_ridrtitest', 'orti_coronavirus_oc43')

        # Deleting field 'RidRTITest.orti_coronavirus_hku1'
        db.delete_column(u'elcid_ridrtitest', 'orti_coronavirus_hku1')

        # Deleting field 'RidRTITest.orti_coronavirus_nl63'
        db.delete_column(u'elcid_ridrtitest', 'orti_coronavirus_nl63')

        # Deleting field 'RidRTITest.orti_coronavirus_229e'
        db.delete_column(u'elcid_ridrtitest', 'orti_coronavirus_229e')
